#1. Básco: imprime todo los números enteros de 0 al 100
for i in range(101):
    print(i)
...
#6. Contador dinámico: establece tres variables: numInicial, numFinal y multiplo. Comenzando en numInicial y pasando por numFinal, imprime los números enteros que sean múltiplos de multiplo. Por ejemplo: si numInicial = 3, numFinal = 10, y multiplo = 2, el bucle deberái imprimiri 4, 6, 8, 10 (en líneas sucesivas).
num_inicial = 3
num_final = 10
multiplo = 2
